    ...
    <tbody>
        @foreach ($users as $user)
            <tr>
                ...
                <td>
                    @if (!$user->bloqueado)
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalBlq">
                        ...
                        @include('partials.modal-messages', ['paramId' => 'modalBlq', 'title' => 'Bloquear Utilizador', 'text' => 'Tem a certeza que pretende bloquear o utilizador "'. $user->name .'" ?'])
                    @else
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modalBlq">
                        ...
                        @include('partials.modal-messages', ['paramId' => 'modalBlq', 'title' => 'Desbloquear Utilizador', 'text' => 'Quer bloquear o utilizador "'. $user->name .'" ?'])
                    @endif

                    @if (!$user->adm)
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalAdm">
                        ...
                        @include('partials.modal-messages', ['paramId' => 'modalAdm', 'title' => 'Privilégios Admin', 'text' => 'Dar privilégios de admin a "'. $user->name .'" ?'])
                    @else
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modalAdm">
                        ...
                        @include('partials.modal-messages', ['paramId' => 'modalAdm', 'title' => 'Privilégios Admin', 'text' => 'Revogar privilégios de admin a "'. $user->name .'" ?'])
                    @endif
                </td>
            </tr>
