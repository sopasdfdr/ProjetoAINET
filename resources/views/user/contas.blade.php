...
@section('content')
<a type="button" class="btn btn-info float-right ml-2 mb-3" style="color: white" href="{{route('contas.removed')}}">Contas Removidas</a>
<a type="button" class="btn btn-success float-right mb-3" style="color: white" href="{{route('conta.create')}}">Criar conta</a>
@include('user.partials.table_contas')
...
{{ $contasAuth->withQueryString()->links() }}
